<template>
  <form action="#" @submit.prevent="onSubmit">
     ...
     <div class="ui labeled input fluid">
       <div class="ui label">
         <i class="netherlands flag"></i> Dutch
       </div>
       <input type="text" placeholder="Enter word..." v-model="word.dutch" />
     </div>
 ...
 export default {
   ...
   methods: {
     onSubmit: function() {
        if (this.word.english === '' || this.word.german ==='' || this.word.vietnamese ==='' || this.word.dutch ==='') {
